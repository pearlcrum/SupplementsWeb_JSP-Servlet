	...
	<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
		<thead>
			...
			<form method="post" action="search">
				<input type="radio" name="choice" value="title" checked="checked">제목별
				<input type="radio" name="choice" value="userId">작성자별
				<input type="radio" name="choice" value="content">내용별
